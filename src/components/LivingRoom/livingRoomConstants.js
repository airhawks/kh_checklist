...
export const LivingRoomTypeOfWorkOptions = [
  "Breaking",
  "Civil Work",
  "New Flooring",
  "Electrical",
...
export const NewlyRequiredItemsOptions = {
  Sofa: { label: "Sofa", src: SofaImage },
  "Love Seat": { label: "Love Seat", src: LoveSeatImage },
  Chairs: { label: "Chairs", src: ChairImage },
  Ottoman: { label: "Ottoman", src: OttomanImage },
  "Center Table": { label: "Center Table", src: CenterTableImage },
  "Side Table": { label: "Side Table", src: SideTableImage },
  "TV Unit": { label: "TV Unit", src: TVUnitImage },
  "Dinning Table Set": { label: "Dinning Table Set", src: DiningTableSetImage },
  Plants: { label: "Plants", src: PlantsImage },
...
export const TVUnitLayoutFactorOptions = [
  "Position of TV (wall mounted or placed on Unit)",
  "Storage above TV",
  "Storage on sides of TV (Towers)",
  "Base cabinet design (storage below TV)",
  "Open shelves or closed with shutters",
  "Material (Ply, wood, corian, glass, marble)",
...
export const LivingRoomAccessoriesOptions = {
  "Wall Decor": { label: "Wall Decor", src: WallDecorImage },
  "Curtain Rod": { label: "Curtain Rod", src: CurtainRodImage },
  "Throw Pillows": { label: "Throw Pillows", src: ThrowPillowsImage },
